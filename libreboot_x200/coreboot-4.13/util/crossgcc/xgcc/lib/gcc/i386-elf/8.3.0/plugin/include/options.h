...
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1U << 5)
#define OPTION_MASK_ISA_MOVDIR64B (HOST_WIDE_INT_1U << 6)
...
#define OPTION_MASK_ISA_RDPID (HOST_WIDE_INT_1U << 10)
...
#define OPTION_MASK_ISA_SGX (HOST_WIDE_INT_1U << 11)
...
#endif
#if defined(HOST_BITS_PER_WIDE_INT) && 14 > HOST_BITS_PER_WIDE_INT
...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1190,            /* -m128bit-long-double */
  OPT_m16 = 1191,                            /* -m16 */
  OPT_m32 = 1192,                            /* -m32 */
  OPT_m3dnow = 1193,                         /* -m3dnow */
  OPT_m3dnowa = 1194,                        /* -m3dnowa */
  OPT_m64 = 1195,                            /* -m64 */
  OPT_m80387 = 1196,                         /* -m80387 */
  OPT_m8bit_idiv = 1197,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1198,             /* -m96bit-long-double */
  OPT_mabi_ = 1199,                          /* -mabi= */
  OPT_mabm = 1200,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1201,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1202,                 /* -maddress-mode= */
  OPT_madx = 1203,                           /* -madx */
  OPT_maes = 1204,                           /* -maes */
  OPT_malign_data_ = 1205,                   /* -malign-data= */
  OPT_malign_double = 1206,                  /* -malign-double */
  OPT_malign_functions_ = 1207,              /* -malign-functions= */
  OPT_malign_jumps_ = 1208,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1209,                  /* -malign-loops= */
  OPT_malign_stringops = 1210,               /* -malign-stringops */
  OPT_march_ = 1211,                         /* -march= */
  OPT_masm_ = 1212,                          /* -masm= */
  OPT_mavx = 1213,                           /* -mavx */
  OPT_mavx2 = 1214,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1215,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1216,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1217,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1218,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1219,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1220,                      /* -mavx512bw */
  OPT_mavx512cd = 1221,                      /* -mavx512cd */
  OPT_mavx512dq = 1222,                      /* -mavx512dq */
  OPT_mavx512er = 1223,                      /* -mavx512er */
  OPT_mavx512f = 1224,                       /* -mavx512f */
  OPT_mavx512ifma = 1225,                    /* -mavx512ifma */
  OPT_mavx512pf = 1226,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1227,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1228,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1229,                      /* -mavx512vl */
  OPT_mavx512vnni = 1230,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1231,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1232,                           /* -mbmi */
  OPT_mbmi2 = 1233,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1234,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1235,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1236,                    /* -mcet-switch */
  OPT_mcld = 1237,                           /* -mcld */
  OPT_mclflushopt = 1238,                    /* -mclflushopt */
  OPT_mclwb = 1239,                          /* -mclwb */
  OPT_mclzero = 1240,                        /* -mclzero */
  OPT_mcmodel_ = 1241,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1242, */                    /* -mcpu= */
  OPT_mcrc32 = 1243,                         /* -mcrc32 */
  OPT_mcx16 = 1244,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1245,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1246,            /* -mdump-tune-features */
  OPT_mf16c = 1247,                          /* -mf16c */
  OPT_mfancy_math_387 = 1248,                /* -mfancy-math-387 */
  OPT_mfentry = 1249,                        /* -mfentry */
  OPT_mfma = 1250,                           /* -mfma */
  OPT_mfma4 = 1251,                          /* -mfma4 */
  OPT_mforce_drap = 1252,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1253,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1254,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1255,                       /* -mfpmath= */
  OPT_mfsgsbase = 1256,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1257,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1258, */              /* -mfused-madd */
  OPT_mfxsr = 1259,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1260,             /* -mgeneral-regs-only */
  OPT_mgfni = 1261,                          /* -mgfni */
  OPT_mhard_float = 1262,                    /* -mhard-float */
  OPT_mhle = 1263,                           /* -mhle */
  OPT_miamcu = 1264,                         /* -miamcu */
  OPT_mieee_fp = 1265,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1266,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1267,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1268,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1269,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1270,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1271, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1272,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1273,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1274,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1275,                /* -mlong-double-80 */
  OPT_mlwp = 1276,                           /* -mlwp */
  OPT_mlzcnt = 1277,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1278,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1279,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1280,                  /* -mmitigate-rop */
  OPT_mmmx = 1281,                           /* -mmmx */
  OPT_mmovbe = 1282,                         /* -mmovbe */
  OPT_mmovdir64b = 1283,                     /* -mmovdir64b */
  OPT_mmovdiri = 1284,                       /* -mmovdiri */
  OPT_mmpx = 1285,                           /* -mmpx */
  ...
  OPT_mpc32 = 1296,                          /* -mpc32 */
  OPT_mpc64 = 1297,                          /* -mpc64 */
  OPT_mpc80 = 1298,                          /* -mpc80 */
  OPT_mpclmul = 1299,                        /* -mpclmul */
  OPT_mpcommit = 1300,                       /* -mpcommit */
  OPT_mpconfig = 1301,                       /* -mpconfig */
  OPT_mpku = 1302,                           /* -mpku */
  OPT_mpopcnt = 1303,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1304, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1305,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1306,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1307,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1308,                        /* -mprfchw */
  OPT_mpush_args = 1309,                     /* -mpush-args */
  OPT_mrdpid = 1310,                         /* -mrdpid */
  OPT_mrdrnd = 1311,                         /* -mrdrnd */
  OPT_mrdseed = 1312,                        /* -mrdseed */
  OPT_mrecip = 1313,                         /* -mrecip */
  OPT_mrecip_ = 1314,                        /* -mrecip= */
  OPT_mrecord_mcount = 1315,                 /* -mrecord-mcount */
  OPT_mred_zone = 1316,                      /* -mred-zone */
  OPT_mregparm_ = 1317,                      /* -mregparm= */
  OPT_mrtd = 1318,                           /* -mrtd */
  OPT_mrtm = 1319,                           /* -mrtm */
  OPT_msahf = 1320,                          /* -msahf */
  OPT_msgx = 1321,                           /* -msgx */
  OPT_msha = 1322,                           /* -msha */
  OPT_mshstk = 1323,                         /* -mshstk */
  OPT_mskip_rax_setup = 1324,                /* -mskip-rax-setup */
  OPT_msoft_float = 1325,                    /* -msoft-float */
  OPT_msse = 1326,                           /* -msse */
  OPT_msse2 = 1327,                          /* -msse2 */
  OPT_msse2avx = 1328,                       /* -msse2avx */
  OPT_msse3 = 1329,                          /* -msse3 */
  OPT_msse4 = 1330,                          /* -msse4 */
  OPT_msse4_1 = 1331,                        /* -msse4.1 */
  OPT_msse4_2 = 1332,                        /* -msse4.2 */
  OPT_msse4a = 1333,                         /* -msse4a */
  /* OPT_msse5 = 1334, */                    /* -msse5 */
  OPT_msseregparm = 1335,                    /* -msseregparm */
  OPT_mssse3 = 1336,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1337,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1338, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1339,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1340, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1341,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1342,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1343,            /* -mstringop-strategy= */
  OPT_mstv = 1344,                           /* -mstv */
  OPT_mtbm = 1345,                           /* -mtbm */
  OPT_mtls_dialect_ = 1346,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1347,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1348,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1349,                         /* -mtune= */
  OPT_mvaes = 1350,                          /* -mvaes */
  OPT_mveclibabi_ = 1351,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1352,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1353,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1354,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1355,                      /* -mwbnoinvd */
  OPT_mx32 = 1356,                           /* -mx32 */
  OPT_mxop = 1357,                           /* -mxop */
  OPT_mxsave = 1358,                         /* -mxsave */
  OPT_mxsavec = 1359,                        /* -mxsavec */
  OPT_mxsaveopt = 1360,                      /* -mxsaveopt */
  OPT_mxsaves = 1361,                        /* -mxsaves */
  OPT_n = 1362,                              /* -n */
  OPT_no_canonical_prefixes = 1363,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1364,              /* -no-integrated-cpp */
  OPT_no_pie = 1365,                         /* -no-pie */
  OPT_nocpp = 1366,                          /* -nocpp */
  OPT_nodefaultlibs = 1367,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1368,                   /* -nostartfiles */
  OPT_nostdinc = 1369,                       /* -nostdinc */
  OPT_nostdinc__ = 1370,                     /* -nostdinc++ */
  OPT_nostdlib = 1371,                       /* -nostdlib */
  OPT_o = 1372,                              /* -o */
  OPT_p = 1373,                              /* -p */
  OPT_pass_exit_codes = 1374,                /* -pass-exit-codes */
  /* OPT_pedantic = 1375, */                 /* -pedantic */
  OPT_pedantic_errors = 1376,                /* -pedantic-errors */
  OPT_pg = 1377,                             /* -pg */
  OPT_pie = 1378,                            /* -pie */
  OPT_pipe = 1379,                           /* -pipe */
  ...
  OPT_quiet = 1391,                          /* -quiet */
  OPT_r = 1392,                              /* -r */
  OPT_remap = 1393,                          /* -remap */
  OPT_s = 1394,                              /* -s */
  OPT_save_temps = 1395,                     /* -save-temps */
  OPT_save_temps_ = 1396,                    /* -save-temps= */
  OPT_shared = 1397,                         /* -shared */
  OPT_shared_libgcc = 1398,                  /* -shared-libgcc */
  /* OPT_specs = 1399, */                    /* -specs */
  OPT_specs_ = 1400,                         /* -specs= */
  OPT_static = 1401,                         /* -static */
  OPT_static_libasan = 1402,                 /* -static-libasan */
  OPT_static_libgcc = 1403,                  /* -static-libgcc */
  OPT_static_libgfortran = 1404,             /* -static-libgfortran */
  OPT_static_libgo = 1405,                   /* -static-libgo */
  OPT_static_liblsan = 1406,                 /* -static-liblsan */
  OPT_static_libmpx = 1407,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1408,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1409,               /* -static-libstdc++ */
  OPT_static_libtsan = 1410,                 /* -static-libtsan */
  OPT_static_libubsan = 1411,                /* -static-libubsan */
  OPT_static_pie = 1412,                     /* -static-pie */
  /* OPT_std_c__03 = 1413, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1414, */                /* -std=c++0x */
  OPT_std_c__11 = 1415,                      /* -std=c++11 */
  OPT_std_c__14 = 1416,                      /* -std=c++14 */
  OPT_std_c__17 = 1417,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1418, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1419, */                /* -std=c++1z */
  OPT_std_c__2a = 1420,                      /* -std=c++2a */
  OPT_std_c__98 = 1421,                      /* -std=c++98 */
  OPT_std_c11 = 1422,                        /* -std=c11 */
  OPT_std_c17 = 1423,                        /* -std=c17 */
  /* OPT_std_c18 = 1424, */                  /* -std=c18 */
  /* OPT_std_c1x = 1425, */                  /* -std=c1x */
  /* OPT_std_c89 = 1426, */                  /* -std=c89 */
  OPT_std_c90 = 1427,                        /* -std=c90 */
  OPT_std_c99 = 1428,                        /* -std=c99 */
  /* OPT_std_c9x = 1429, */                  /* -std=c9x */
  OPT_std_f2003 = 1430,                      /* -std=f2003 */
  OPT_std_f2008 = 1431,                      /* -std=f2008 */
  OPT_std_f2008ts = 1432,                    /* -std=f2008ts */
  OPT_std_f2018 = 1433,                      /* -std=f2018 */
  OPT_std_f95 = 1434,                        /* -std=f95 */
  OPT_std_gnu = 1435,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1436, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1437, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1438,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1439,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1440,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1441, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1442, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1443,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1444,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1445,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1446,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1447, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1448, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1449, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1450,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1451,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1452, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1453, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1454,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1455, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1456, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1457, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1458, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1459, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1460,                     /* -std=legacy */
  OPT_symbolic = 1461,                       /* -symbolic */
  OPT_t = 1462,                              /* -t */
  OPT_time = 1463,                           /* -time */
  OPT_time_ = 1464,                          /* -time= */
  OPT_traditional = 1465,                    /* -traditional */
  OPT_traditional_cpp = 1466,                /* -traditional-cpp */
  OPT_trigraphs = 1467,                      /* -trigraphs */
  OPT_u = 1468,                              /* -u */
  OPT_undef = 1469,                          /* -undef */
  OPT_v = 1470,                              /* -v */
  OPT_version = 1471,                        /* -version */
  OPT_w = 1472,                              /* -w */
  OPT_wrapper = 1473,                        /* -wrapper */
  OPT_x = 1474,                              /* -x */
  OPT_z = 1475,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
