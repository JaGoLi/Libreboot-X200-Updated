...
#line 369 "bincfg.y"
				  ...
				  binary->actualblob); }
#line 1434 "bincfg.tab.c"
    break;

  case 6: /* spec: '{' '}'  */
#line 374 "bincfg.y"
                        {	fprintf (stderr, "No spec\n"); }
#line 1440 "bincfg.tab.c"
    break;
