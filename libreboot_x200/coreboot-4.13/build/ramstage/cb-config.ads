package CB.Config is
   ...
   X86_SMM_LOADER_VERSION2                        : constant boolean := false;
   ...
   SMMSTORE_V2                                    : constant boolean := false;
   SMMSTORE_IN_CBFS                               : constant boolean := false;
   SMMSTORE_REGION                                : constant string  := "SMMSTORE";
   SMMSTORE_FILENAME                              : constant string  := "smm_store";
