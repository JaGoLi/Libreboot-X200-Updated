...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_COREBOOT=1 -DGRUB_MACHINE=I386_COREBOOT -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
