package CB.Config is
   ...
   STATIC_OPTION_TABLE                            : constant boolean := true;
   ...
   SMBIOS_ENCLOSURE_TYPE                          : constant         := 16#0009#;
   ...
   NO_FIXED_XIP_ROM_SIZE                          : constant boolean := false;
   XIP_ROM_SIZE                                   : constant         := 16#0001_0000#;
   ...
   DIGITIZER_AUTODETECT                           : constant boolean := false;
   DIGITIZER_PRESENT                              : constant boolean := false;
   DIGITIZER_ABSENT                               : constant boolean := true;
   ...
   DRIVERS_GENERIC_WIFI                           : constant boolean := false;
   ...
   SECURITY_CLEAR_DRAM_ON_REGULAR_BOOT            : constant boolean := true;
   ...
   COMMON_FADT                                    : constant boolean := false;
